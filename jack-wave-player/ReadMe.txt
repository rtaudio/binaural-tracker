========================================================================
    KONSOLENANWENDUNG: jack-wave-player-Projektübersicht
========================================================================

Diese jack-wave-player-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre jack-wave-player-Anwendung besteht.


jack-wave-player.vcxproj
...
jack-wave-player.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen jack-wave-player.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
